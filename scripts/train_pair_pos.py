...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train the positive-neighbor pairwise EBM.")
...
def main() -> int:
    ...
    print(
        f"[pair-train] model=pos num_tasks={len(tasks)} "
    ...
    results = []
    for task in tqdm(tasks, desc="Train pos tasks"):
        results.append(
            train_pair_task(
            task=task,

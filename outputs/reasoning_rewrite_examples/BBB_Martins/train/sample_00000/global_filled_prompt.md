You are rewriting a rough global-model middle draft into high-quality reasoning SFT data for task BBB_Martins where option (A) means does not cross the BBB and option (B) means crosses the BBB.
...
Hard requirements:
1. Use only the task playbook and the supplied global middle draft.
...
4. Keep the final reasoning faithful to the original draft direction while making the prose more natural and scientific.
5. Use the playbook as a semantic interpreter, not as a second classifier.
6. If the original draft contains mixed evidence, preserve that tension before giving the final conclusion.

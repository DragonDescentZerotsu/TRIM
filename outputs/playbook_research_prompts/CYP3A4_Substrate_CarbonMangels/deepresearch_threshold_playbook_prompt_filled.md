...
Task:
TDC task CYP3A4_Substrate_CarbonMangels, where option (A) means is not a substrate to the enzyme CYP3A4 and option (B) means is a substrate to the enzyme CYP3A4

...
Task:
TDC task PAMPA_NCATS, where option (A) means is not permeable to cell membranes in a PAMPA assay and option (B) means is permeable to cell membranes in a PAMPA assay

...
Task:
TDC task CYP2D6_Substrate_CarbonMangels, where option (A) means is not a substrate to the enzyme CYP2D6 and option (B) means is a substrate to the enzyme CYP2D6

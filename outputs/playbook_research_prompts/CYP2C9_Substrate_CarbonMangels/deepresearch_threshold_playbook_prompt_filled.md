...
Task:
TDC task CYP2C9_Substrate_CarbonMangels, where option (A) means is not a substrate to the enzyme CYP2C9 and option (B) means is a substrate to the enzyme CYP2C9
